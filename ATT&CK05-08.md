...
### [Component Firmware](https://attack.mitre.org/techniques/T1109/)(组件固件)(Windows)
...
### [Component Object Model Hijacking](https://attack.mitre.org/techniques/T1122/)(组件对象模型劫持)(Windows)
...
### [Connection Proxy](https://attack.mitre.org/techniques/T1090/)(连接代理)(All)
...
- 攻击者可能会随着时间推移和协议构建改变工具C2的签名，以避免被常见防御工具发现。
